...
class YogaDao(ClaseDao):  # YogaDao hereda de ClaseDao (relación jerárquica)
    """
    Data Access Object para la entidad Yoga.
    Hereda de ClaseDao (que a su vez hereda de Dao).
    """

    TABLA_HIJA = "yoga"  # Tabla propia de este tipo de clase

    def crear_tabla(self):  # Sobrescribe crear_tabla para incluir la tabla hija
        """
        Crea la tabla padre 'clases' y luego la tabla 'yoga':
